...
public class LocalBinlogInfo {
    ...
    public static final String lastDownloadFileTable = "t_binlog_down_last_file";
    public static final String binlogDownloadRecordTable = "t_binlog_record";
    public static final String binlogProcessTable = "t_binlog_process";
